...
class TipoPlato(models.Model):
    ...
    id_tipo_plato = fields.Integer(string='ID Tipo Plato', readonly=True, required=True, index=True, default=lambda self: self.env['ir.sequence'].next_by_code('vilaexplorer.tipo_plato'))
