...
class Coordenadas(models.Model):
    ...
    id_coordenadas = fields.Integer(string='ID Coordenadas', required=True, index=True, default=lambda self: self.env['ir.sequence'].next_by_code('vilaexplorer.coordenadas'))
